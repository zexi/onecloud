...
const (
	...
	CONTAINER_CPH_AMD_GPU      = "CPH_AMD_GPU"
	CONTAINER_CPH_AOSP_BINDER  = "CPH_AOSP_BINDER"
	CONTAINER_NETINT_CA_ASIC   = "NETINT_CA_ASIC"
	CONTAINER_NETINT_CA_QUADRA = "NETINT_CA_QUADRA"
...
var VALID_CONTAINER_DEVICE_TYPES = []string{CONTAINER_CPH_AMD_GPU, CONTAINER_CPH_AOSP_BINDER, CONTAINER_NETINT_CA_QUADRA, CONTAINER_NETINT_CA_ASIC}
