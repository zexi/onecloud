...
const (
	...
	CONTAINER_CPH_AMD_GPU     = "CONTAINER_CPH_AMD_GPU"
	CONTAINER_CPH_AOSP_BINDER = "CONTAINER_CPH_AOSP_BINDER"
...
var VALID_CONTAINER_DEVICE_TYPES = []string{CONTAINER_CPH_AMD_GPU, CONTAINER_CPH_AOSP_BINDER}
