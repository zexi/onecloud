...
type LLMImageListOptions struct {
	...
	LLMType string `json:"llm_type" choices:"ollama|dify|vllm|comfyui" help:"filter by llm type"`
}
...
type LLMImageCreateOptions struct {
	...
	LLM_TYPE     string `json:"llm_type" choices:"ollama|dify|vllm|comfyui" help:"llm type: ollama, vllm, comfyui or dify"`
}
...
type LLMImageUpdateOptions struct {
	...
	CredentialId string `json:"credential_id"`
	LlmType      string `json:"llm_type" choices:"ollama|dify|vllm|comfyui" help:"llm type: ollama, vllm, comfyui or dify"`
}
